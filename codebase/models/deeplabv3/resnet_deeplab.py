"""
OS: output stride, the ratio of input image resolution to final output resolution
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_channels, channels, stride=1, dilation=1):
        ...
        self.conv2 = nn.Conv3d(channels, channels, kernel_size=3, stride=stride,
                               padding=dilation, dilation=dilation, bias=False)
        self.bn2 = nn.BatchNorm3d(channels)
...
class ResNet_Bottleneck_OS16(nn.Module):
    def __init__(self, num_layers, input_channels):
        ...
        self.layer5 = make_layer(Bottleneck, in_channels=4*256,
                                 channels=512, num_blocks=3, stride=1, dilation=2)
...
class ResNet_BasicBlock_OS16(nn.Module):
    def __init__(self, num_layers, input_channels):
        ...
        self.layer5 = make_layer(BasicBlock, in_channels=256, channels=512,
                                 num_blocks=num_blocks, stride=1, dilation=2)
...
class ResNet_BasicBlock_OS8(nn.Module):
    def __init__(self, num_layers, input_channels):
        ...
        self.layer4 = make_layer(BasicBlock, in_channels=128, channels=256,
